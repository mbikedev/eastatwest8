    ...
    <>
      ...
      <header className="relative h-screen w-full overflow-hidden" role="banner" aria-label="East @ West Restaurant Hero Section">
        ...
        <div className="absolute inset-0 overflow-hidden z-5">
          <motion.div
            className={`absolute top-20 left-10 w-32 h-32 rounded-full opacity-20 blur-xl ${
              theme === 'dark' ? 'bg-gradient-to-r from-[#1A1A1A] to-[#1A1A1A]' : 'bg-gradient-to-r from-[#A8D5BA] to-[#A8D5BA]'
            }`}
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className={`absolute inset-0 z-15 ${
            theme === 'dark'
              ? 'bg-gradient-to-br from-black/60 via-[#1A1A1A]/30 to-[#1A1A1A]/40'
              : 'bg-gradient-to-br from-black/60 via-[#A8D5BA]/30 to-[#1A1A1A]/40'
          }`}></div>
        </div>
        ...
        <motion.button
          onClick={toggleMute}
          className={`absolute top-6 right-6 z-30 p-4 rounded-full text-white transition-all duration-300 shadow-2xl backdrop-blur-sm ${
            theme === 'dark'
              ? 'bg-gradient-to-r from-[#1A1A1A] to-[#1A1A1A] hover:from-[#FFFFFF] hover:to-[#FFFFFF] hover:text-[#1A1A1A]'
              : 'bg-gradient-to-r from-[#A8D5BA] to-[#A8D5BA] hover:from-[#1A1A1A] hover:to-[#1A1A1A]'
          }`}
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <div className="text-center px-4 sm:px-6 lg:px-8 max-w-6xl">
            ...
            <motion.h1
              className={`text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black mb-6 sm:bg-transparent bg-black/40 ${
            ...
            <p
              className="lcp-text text-xl sm:text-2xl text-[#FFFFFF]/90 mb-10 max-w-3xl mx-auto"
            ...
            >
              <Link
                href="/reservations"
                className={`group relative inline-block text-[#FFFFFF] px-8 py-4 sm:px-10 sm:py-5 rounded-2xl text-lg sm:text-xl font-bold transition-all duration-300 transform hover:scale-105 focus:scale-105 shadow-2xl focus:outline-none focus:ring-4 ${
                  theme === 'dark'
                    ? 'focus:ring-[#1A1A1A]/50'
                    : 'bg-[#A8D5BA] focus:ring-[#A8D5BA]/50'
                }`}
                aria-label="Reserve your table at East @ West"
                style={{ backgroundColor: '#302e2e' }}
              >
                <span className="relative z-10">{t("hero.cta")}</span>
                <div className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-300 ${
                  theme === 'dark'
                    ? 'bg-gradient-to-r from-[#1A1A1A] to-[#FFFFFF] text-[#1A1A1A]'
                    : 'bg-gradient-to-r from-[#A8D5BA] to-[#1A1A1A]'
                }`}></div>
              </Link>
              <Link
                href="/menu"
                className="group relative inline-block border-3 border-[#FFFFFF] backdrop-blur-sm text-[#FFFFFF] hover:bg-[#FFFFFF] hover:text-[#1A1A1A] focus:bg-[#FFFFFF] focus:text-[#1A1A1A] px-8 py-4 sm:px-10 sm:py-5 rounded-2xl text-lg sm:text-xl font-bold transition-all duration-300 transform hover:scale-105 focus:scale-105 shadow-2xl bg-transparent focus:outline-none focus:ring-4 focus:ring-white/50"
              ...
              <Link
                href="/gallery"
                className={`group relative inline-block border-2 backdrop-blur-sm text-[#FFFFFF] px-8 py-4 sm:px-10 sm:py-5 rounded-2xl text-lg sm:text-xl font-bold transition-all duration-300 transform hover:scale-105 focus:scale-105 bg-transparent focus:outline-none focus:ring-4 ${
                  theme === 'dark'
                    ? 'border-[#1A1A1A]/50 hover:border-[#1A1A1A] focus:border-[#1A1A1A] focus:ring-[#1A1A1A]/50'
                    : 'border-[#A8D5BA]/50 hover:border-[#A8D5BA] focus:border-[#A8D5BA] focus:ring-[#A8D5BA]/50'
                }`}
      ...
      <main
        className={`relative py-24 px-4 sm:px-6 lg:px-8 ${
          theme === 'dark' ? 'bg-gradient-to-br from-[#1A1A1A] via-[#1A1A1A]/20 to-[#1A1A1A]' : 'bg-gradient-to-br from-[#F5F0E6] via-[#A8D5BA]/30 to-[#F5F0E6]'
        }`}
        role="main"
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            className={`absolute top-32 right-10 w-96 h-96 rounded-full blur-3xl ${
              theme === 'dark'
                ? 'bg-gradient-to-r from-[#1A1A1A]/20 to-[#1A1A1A]/10'
                : 'bg-gradient-to-r from-[#A8D5BA]/20 to-[#A8D5BA]/10'
            }`}
            variants={floatingVariants}
            animate="float"
          />
          <motion.div
            className={`absolute bottom-32 left-10 w-80 h-80 rounded-full blur-3xl ${
              theme === 'dark'
                ? 'bg-gradient-to-r from-[#1A1A1A]/20 to-[#1A1A1A]/20'
                : 'bg-gradient-to-r from-[#A8D5BA]/20 to-[#1A1A1A]/20'
            }`}
            variants={floatingVariants}
            animate="float"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            ...
            <motion.div className="text-center mb-16" variants={itemVariants}>
              ...
              >
                <span className={`font-black ${
                  theme === 'dark' ? 'text-white' : 'bg-clip-text text-transparent bg-black'
                }`}>
              ...
              {todaysSpecials.map((special) => (
                <motion.div
                  ...
                  className={`group relative rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 ${
                    theme === 'dark' ? 'bg-gradient-to-br from-[#F5F0E6] to-[#F5F0E6]' : 'bg-gradient-to-br from-[#FFFFFF] to-[#A8D5BA]/50'
                  }`}
                  variants={itemVariants}
                  whileHover={{ y: -10 }}
                >
                  {/* Gradient Border Effect */}
                  <div className={`absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 p-0.5 ${
                    theme === 'dark'
                      ? 'bg-gradient-to-r from-[#1A1A1A] to-[#1A1A1A]'
                      : 'bg-gradient-to-r from-[#A8D5BA] to-[#A8D5BA]'
                  }`}>
                    <div className={`w-full h-full rounded-3xl ${theme === 'dark' ? 'bg-[#F5F0E6]' : 'bg-[#FFFFFF]'}`}></div>
                  </div>
                  ...
                  <div className="relative z-10">
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className={`absolute top-4 right-4 text-[#FFFFFF] px-4 py-2 rounded-full font-bold text-lg shadow-lg ${
                        theme === 'dark'
                          ? 'bg-gradient-to-r from-[#1A1A1A] to-[#1A1A1A]'
                          : 'bg-gradient-to-r from-[#A8D5BA] to-[#A8D5BA]'
                      }`}>
            ...
            <motion.div className="text-center mb-16" variants={itemVariants}>
              ...
              <Link href="/events-catering" aria-label="Learn more about our events and catering services">
                <div className="relative inline-block">
                  <h2
                    id="events-heading"
                    className={`text-4xl sm:text-5xl font-black mb-6 cursor-pointer hover:scale-105 focus:scale-105 transition-transform duration-300 ${
                      theme === 'dark' ? 'text-white hover:text-[#A8D5BA] focus:text-[#A8D5BA]' : 'text-[#1A1A1A] hover:text-[#A8D5BA] focus:text-[#A8D5BA]'
                    }`}
                    style={{fontFamily: 'Times New Roman, serif'}}
                  >
                    <span className={`font-black ${
              ...
              <p className={`text-lg mt-6 ${theme === 'dark' ? 'text-[#F5F0E6]' : 'text-[#1A1A1A]'}`}>
              ...
              {upcomingEvents.map((event) => (
                <motion.div
                  ...
                  className={`group relative p-8 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 backdrop-blur-sm ${
                    theme === 'dark' ? 'bg-gradient-to-br from-[#1A1A1A]/80 to-[#A8D5BA]/80 border border-[#A8D5BA]' : 'bg-gradient-to-br from-[#FFFFFF]/80 to-[#A8D5BA]/50 border border-[#A8D5BA]'
                  }`}
                  variants={itemVariants}
                  whileHover={{ y: -10 }}
                >
                  <div className="flex items-center mb-6">
                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mr-6 text-3xl shadow-xl ${
                      theme === 'dark'
                        ? 'bg-gradient-to-r from-[#1A1A1A] to-[#1A1A1A]'
                        : 'bg-gradient-to-r from-[#A8D5BA] to-[#A8D5BA]'
                    }`}>
                    ...
                    <div className={`${theme === 'dark' ? 'text-[#F5F0E6]' : 'text-[#1A1A1A]'}`} style={{ fontFamily: 'Times New Roman, serif', fontSize: '20px', lineHeight: '28px' }}>
                      {t(event.titleKey)}
                    </div>
                  </div>
                  <p className={`text-base leading-relaxed ${theme === 'dark' ? 'text-[#F5F0E6]' : 'text-[#1A1A1A]'}`}>
                  ...
                  <div className={`absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
                    theme === 'dark'
                      ? 'bg-gradient-to-r from-[#1A1A1A]/10 to-[#1A1A1A]/10'
                      : 'bg-gradient-to-r from-[#A8D5BA]/10 to-[#A8D5BA]/10'
                  }`}></div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="relative z-10 flex items-center justify-center h-full">
              <div className="text-center px-4 sm:px-6 lg:px-8 max-w-4xl">
                ...
                >
                  <Link
                    href="/reservations"
                    className="group relative inline-block text-[#FFFFFF] px-8 py-4 sm:px-10 sm:py-5 rounded-2xl text-lg sm:text-xl font-bold transition-all duration-300 transform hover:scale-105 focus:scale-105 shadow-2xl focus:outline-none focus:ring-4 focus:ring-white/50"
                    aria-label="Book your table - Reserve now at East @ West"
                    style={{ backgroundColor: 'rgba(70, 65, 65, 1)', color: 'rgba(255, 255, 255, 1)' }}
                  >
          ...
          >
            ...
            <motion.div className="mb-12" variants={itemVariants}>
              ...
              <div className="w-32 h-1.5 bg-gradient-to-r from-[#A8D5BA] to-[#A8D5BA] mx-auto rounded-full mb-4"></div>
            ...
            >
              ...
              <article className="flex-shrink-0 flex justify-center" role="listitem">
                <figure className="text-center hover:scale-105 transition-transform duration-300">
                  ...
                  <figcaption className={`text-sm mt-2 ${
                    ...
                    Restaurant Guru Recommended 2021
                  </figcaption>
                </figure>
              </article>
              ...
              <article className="flex-shrink-0 flex justify-center" role="listitem">
                <figure className="text-center hover:scale-105 transition-transform duration-300">
                  ...
                  >
                    <Image
                      src="https://cdn.builder.io/api/v1/image/assets%2Fbe215e77a32d4149b4ac6363162e72c1%2Ff36229ccab334079b526a834d6b72365?format=webp&width=800"
              ...
              <article className="flex-shrink-0 flex justify-center" role="listitem">
                <figure className="text-center hover:scale-105 transition-transform duration-300">
                  ...
                  >
                    <Image
                      src="https://cdn.builder.io/api/v1/image/assets%2Fbe215e77a32d4149b4ac6363162e72c1%2F4fe101158279475cb695b4e8ae54deb3?format=webp&width=800"
