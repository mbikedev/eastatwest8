    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-r from-[#A8D5BA]/20 to-[#A8D5BA]/20 rounded-full blur-3xl"
            variants={floatingVariants}
            animate="float"
          />
          <motion.div
            className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-[#A8D5BA]/20 to-[#1A1A1A]/20 rounded-full blur-3xl"
            variants={floatingVariants}
            animate="float"
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-r from-[#A8D5BA]/10 to-[#A8D5BA]/10 rounded-full blur-3xl"
            variants={floatingVariants}
            animate="float"
          />
          <motion.div
            className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-[#A8D5BA]/10 to-[#1A1A1A]/10 rounded-full blur-3xl"
            variants={floatingVariants}
            animate="float"
            transition={{ delay: 1 }}
          />
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
              ...
              <motion.a
                ...
                className="group relative inline-flex items-center border-3 border-white bg-white/10 backdrop-blur-sm text-white hover:bg-white hover:text-black px-10 py-5 rounded-2xl text-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-2xl"
                whileHover={{ y: -5 }}
                whileTap={{ scale: 0.95 }}
              >
                <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
